...
if datajoint_plus_version != datajoint_plus_github_version:
    logging.warning(f'Imported datajoint.datajoint_plus version, {datajoint_plus_version} does not match the latest version on Github, {datajoint_plus_github_version}.')
